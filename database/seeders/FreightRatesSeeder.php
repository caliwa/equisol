        ...
        DB::transaction(function () {
            ...
            $serviceTypes = [
                'Pick Up Aéreo' => [
                    ...
                    'data' => [
                        'Italia' => ['currency' => null, 'minima' => 50.00, 'rates' => [0.17, 0.14, 0.12, 0.12, 0.11, 0.11]],
                        'Dinamarca' => ['currency' => null, 'minima' => 130.00, 'rates' => [1.10, 1.10, 0.72, 0.71, 0.50, 0.40]],
                        'Suecia' => ['currency' => null, 'minima' => 125.00, 'rates' => [0.25, 0.25, 0.25, 0.25, 0.25, 0.25]],
                        'Reino Unido' => ['currency' => null, 'minima' => 150.00, 'rates' => [0.17, 0.13, 0.12, 0.12, 0.11, 0.11]],
                        'Países Bajos' => ['currency' => null, 'minima' => 300.00, 'rates' => [0.40, 0.20, 0.16, 0.15, 0.14, 0.13]],
                        'Alemania' => ['currency' => null, 'minima' => 350.00, 'rates' => [0.45, 0.22, 0.18, 0.16, 0.15, 0.14]],
                        'Estados Unidos' => ['currency' => null, 'minima' => 130.00, 'rates' => [2.24, 2.24, 2.24, 2.24, 2.24, 2.24]],
                        'Brasil' => ['currency' => null, 'minima' => 50.00, 'rates' => [0.38, 0.38, 0.38, 0.38, 0.38, 0.38]],
                        'España' => ['currency' => null, 'minima' => 300.00, 'rates' => [1.01, 1.01, 1.01, 1.01, 1.01, 1.01]],
                        'China' => ['currency' => null, 'minima' => 110.00, 'rates' => [0.76, 0.76, 0.76, 0.76, 0.76, 0.76]],
                    ]
                ],
                'Pick Up Marítimo' => [
                    'weight_tiers' => [
                    ...
                    'data' => [
                        'Italia' => ['currency' => null, 'minima' => 80.00, 'rates' => [0.20, 0.19, 0.18, 0.15, 0.14, 0.14]],
                        'Dinamarca' => ['currency' => null, 'minima' => 300.00, 'rates' => [0.51, 0.54, 0.62, 0.70, 0.77, 0.80]],
                        'Suecia' => ['currency' => null, 'minima' => 400.00, 'rates' => [0.58, 0.58, 0.66, 0.70, 0.77, 0.80]],
                        'Reino Unido' => ['currency' => null, 'minima' => 150.00, 'rates' => [0.17, 0.13, 0.12, 0.12, 0.11, 0.11]],
                        'Países Bajos' => ['currency' => null, 'minima' => 140.00, 'rates' => [0.18, 0.17, 0.13, 0.12, 0.12, 0.11]],
                        'Alemania' => ['currency' => null, 'minima' => 350.00, 'rates' => [0.45, 0.22, 0.18, 0.16, 0.15, 0.14]],
                        'Estados Unidos' => ['currency' => null, 'minima' => 125.00, 'rates' => [2.56, 2.16, 1.64, 1.52, 1.45, 1.30]],
                        'Brasil' => ['currency' => null, 'minima' => 365.00, 'rates' => [0.36, 0.36, 0.36, 0.36, 0.36, 0.36]],
                        'España' => ['currency' => null, 'minima' => 450.00, 'rates' => [0.51, 0.36, 0.25, 0.20, 0.17, 0.15]],
                        'China' => ['currency' => null, 'minima' => 115.00, 'rates' => [0.12, 0.08, 0.08, 0.07, 0.07, 0.05]],
                    ]
                ],
                'Flete Aéreo' => [
                    'weight_tiers' => [
