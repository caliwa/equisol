...
>
    ...
    <div x-show="isVisibleDichotomicAskingModal"
        x-effect="
            ...
            if (isVisibleDichotomicAskingModal && !modalStack.includes('isVisibleDichotomicAskingModal')) {
                ...
                document.getElementById('isVisibleDichotomicAskingModal').classList.add('fade-out-scale');
            }
    ...
    <div class="bg-white dark:bg-gray-800">
        <div x-show="isVisibleDichotomicAskingModal" id="isVisibleDichotomicAskingModal"
