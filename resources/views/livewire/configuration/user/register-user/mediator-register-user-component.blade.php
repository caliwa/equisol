...
<livewire:configuration.user.register-user.edit-register-user-modal-component wire:key="erumc-1"/>

<livewire:configuration.user.register-user.index-register-user-component wire:key="iruc-1"/>
