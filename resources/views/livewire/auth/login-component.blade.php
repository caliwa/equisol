<div class="flex min-h-screen">
    <div class="flex-1 flex justify-center items-center">
        <div class="w-80 max-w-80 space-y-6">
            ...
            <flux:heading class="text-center" size="xl">Bienvenido nuevamente!</flux:heading>
            ...
            <div class="flex flex-col gap-6">
                ...
                <flux:checkbox label="Recuerdame por 30 días" />

                <flux:button wire:click="LoginButton" variant="primary" color="blue" class="w-full">Entrar</flux:button>
    ...
    <div class="flex-1 p-4 max-lg:hidden">
        <div class="text-white relative rounded-lg h-full w-full bg-zinc-900 flex flex-col items-start justify-end p-16" style="background-image: url('https://wallpaperbat.com/img/799198-industrial-wallpaper.jpg'); background-size: cover">
            ...
            <div class="mb-6 italic font-base text-blue-400 text-3xl xl:text-4xl">
                Equisol
            </div>

            <div class="flex gap-4">
                <flux:avatar src="https://equisol.com.co/wp-content/uploads/2023/08/Equisol.svg" size="xl" />

                <div class="flex flex-col justify-center font-medium">
                    <div class="text-lg">Aplicación Web</div>
                    <div class="text-zinc-300">Cotizador F.I</div>
                </div>
            </div>
        </div>
    </div>
